...
![Weather Dashboard](public/assets/images/favicon-32x32.png)
...
- **Unit Toggling**: Seamlessly switch between Celsius (°C) and Fahrenheit (°F) with immediate data updates.
